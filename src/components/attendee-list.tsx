      ...
      <Table>
          <thead>
            <tr className="border-b border-white/10">
              <TableHeader className="py-3 px-4 text-sm font-semibold text-left" style={{width:48}}>
              ...
              <TableHeader style={{width:48}} className="py-3 px-4 text-sm font-semibold text-left"></TableHeader>
            </tr>
          </thead>
          <tbody>
            {

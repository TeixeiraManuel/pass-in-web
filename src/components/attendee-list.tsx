  ...
  return(
    <div className="flex flex-col gap-4">
      <div className="flex gap-3 items-center">
        ...
        <input className="flex-1 bg-transparent outline-none border-0 p-0 text-sm" placeholder="Buscar participantes.." />
        </div>
      </div>
                ...
                return(
                    ...
                    <td className="py-3 px-4 text-sm text-zinc-300">
                      <div className="flex flex-col gap-1">
                        <span className="font-semibold text-white">Teixeira Manuel</span>
                        <span>Teidy</span>
                      </div>
                    </td>
